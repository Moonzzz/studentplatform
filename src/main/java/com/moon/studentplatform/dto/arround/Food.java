...
public class Food {
  ...
  public Food(long id, String name, String position, String description, String photos) {
    this.id = id;
    this.name = name;
    this.position = position;
    this.description = description;
  ...
  public Food(String name, String position, String description, String photos) {
    this.name = name;
    this.position = position;
    this.description = description;
    this.photos = photos;
